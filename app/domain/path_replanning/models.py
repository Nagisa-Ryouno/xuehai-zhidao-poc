# -*- coding: utf-8 -*-
"""
app/domain/path_replanning/models.py
学海智导 V2 - Path Replanning Domain Models & Canonical Serializer

定义路径决策枚举、合法决策矩阵、4位定点规范化函数及确定性业务载荷与审计模型。
严格遵守纯内存计算 (Zero IO, Zero Framework, Pure Logic)。
"""
