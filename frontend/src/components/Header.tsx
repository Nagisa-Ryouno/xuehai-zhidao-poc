      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3.5 shrink-0">
          ...
          <div className="shrink-0">
            <div className="flex items-center gap-2 shrink-0">
              <span className="text-lg sm:text-xl font-bold tracking-tight text-slate-900 whitespace-nowrap flex-shrink-0 select-none">
                学海智导
              </span>
            </div>
        ...
        <div className="flex items-center gap-2.5 sm:gap-4 shrink-0">
          ...
          <div className="relative flex items-center gap-1.5 sm:gap-2">
            <div className="relative flex items-center bg-slate-100 hover:bg-slate-200/80 text-slate-800 rounded-xl px-2.5 sm:px-3 py-1.5 min-h-[40px] border border-slate-200 transition-all cursor-pointer shadow-xs max-w-[130px] sm:max-w-none">
