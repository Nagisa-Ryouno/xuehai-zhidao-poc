/**
 * quizBankData.ts
 * 学海智导 (Xuehai Zhidao) — 30/30 考点微测验离线备选题库
 */
...
export interface QuizQuestionInternal extends QuizQuestionPublic {
  answer: string;
  explanation: string;
}

export const OFFLINE_QUIZ_QUESTIONS: QuizQuestionInternal[] = [
  {
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "C",
        "text": "货币发行总量由谁决定 (Who controls money)"
      },
      {
        "key": "D",
        "text": "为谁生产 (For whom)"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "B",
        "text": "生产这第 101 件商品，因为边际收益(18)大于边际成本(15)"
      },
      {
        "key": "C",
        "text": "保持原产量不变，因为边际成本大于零"
      },
      {
        "key": "D",
        "text": "取决于之前的平均利润是否为正"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "供不应求（短缺），买方竞价促使价格上涨"
      },
      {
        "key": "B",
        "text": "供过于求（过剩），卖方竞相降价促使价格回落"
      },
      {
        "key": "C",
        "text": "市场自发静止，价格永久锁定在当前高位"
      },
      {
        "key": "D",
        "text": "供给量小于需求量，政府必须出面限价"
      }
    ],
    "difficulty": 1,
    "answer": "B",
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "均衡价格必然上升，均衡数量必然增加"
      },
      {
        "key": "B",
        "text": "均衡价格必然下降，均衡数量必然减少"
      },
      {
        "key": "C",
        "text": "均衡数量必然增加，均衡价格的变动方向无法确定"
      },
      {
        "key": "D",
        "text": "均衡价格与均衡数量的变动方向均无法确定"
      }
    ],
    "difficulty": 2,
    "answer": "C",
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "B",
        "text": "该商品的支出占消费者预算比例极小"
      },
      {
        "key": "C",
        "text": "消费者考察该商品的时间非常短促"
      },
      {
        "key": "D",
        "text": "该商品拥有众多且容易获取的相近替代品"
      }
    ],
    "difficulty": 2,
    "answer": "D",
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "在极短期内，供给量无法迅速调整，供给价格弹性往往接近于零"
      },
      {
        "key": "B",
        "text": "时间周期越长，厂商越难调整要素，长期供给弹性小于短期供给弹性"
      },
      {
        "key": "C",
        "text": "容易储存的商品通常供给弹性比不易储存的商品更低"
      },
      {
        "key": "D",
        "text": "任何商品的供给弹性在长短期中都是固定不变的"
      }
    ],
    "difficulty": 2,
    "answer": "A",
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "法定向谁征税，税负就全部由谁承担"
      },
      {
        "key": "B",
        "text": "相对更缺乏弹性的一方将承担更大部分的税负"
      },
      {
        "key": "C",
        "text": "相对更富有弹性的一方将承担更大部分的税负"
      },
      {
        "key": "D",
        "text": "买卖双方永远平摊税收"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "MRS_xy = Px / Py (即 MUx / Px = MUy / Py)"
      },
      {
        "key": "B",
        "text": "MRS_xy = Py / Px"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "经营时间是否超过 1 个自然年"
      },
      {
        "key": "B",
        "text": "是否所有生产要素的投入量都可以自由调整"
      },
      {
        "key": "C",
        "text": "企业的总收益是否超过了会计成本"
      },
      {
        "key": "D",
        "text": "是否引入了自动化计算机软件"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "增加恰好 100%（规模报酬不变）"
      },
      {
        "key": "B",
        "text": "增加少于 100%（规模报酬递减）"
      },
      {
        "key": "C",
        "text": "增加超过 100%（规模报酬递增）"
      },
      {
        "key": "D",
        "text": "保持不变"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "MC 曲线穿过 ATC 曲线的最高点"
      },
      {
        "key": "B",
        "text": "MC 曲线在其自身的最低点与 ATC 相交"
      },
      {
        "key": "C",
        "text": "MC 曲线穿过 ATC 曲线的最低点（有效规模点）"
      },
      {
        "key": "D",
        "text": "两条曲线在横轴交割"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "B",
        "text": "P > MC，从而导致社会福利出现无谓损失(Deadweight Loss)"
      },
      {
        "key": "C",
        "text": "P < MC"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "key": "C",
        "text": "各厂商生产的产品是否存在差异化(Product Differentiation)"
      },
      {
        "key": "D",
        "text": "厂商是否追求利润最大化"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "厂商之间在决策上具有高度的相互依存性(Interdependence)"
      },
      {
        "key": "B",
        "text": "行业内厂商数量极其庞大"
  ...
  },
  {
    ...
    "options": [
      {
        "key": "A",
        "text": "道德风险 (Moral Hazard)"
      },
      {
        "key": "B",
        "text": "逆向选择 (Adverse Selection)"
      },
      {
        "key": "C",
        "text": "外部经济"
...
export function getOfflineQuestionsByKnowledgeId(knowledgeId: string): QuizQuestionPublic[] {
  return OFFLINE_QUIZ_QUESTIONS
    .filter((q) => q.knowledge_id === knowledgeId)
    .map(({ answer, explanation, ...publicQ }) => publicQ);
}

export function getOfflineQuestionById(questionId: string): QuizQuestionInternal | undefined {
  return OFFLINE_QUIZ_QUESTIONS.find((q) => q.question_id === questionId);
}
