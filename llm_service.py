...
"""
llm_service.py
学海智导 (Xuehai Zhidao) - LLM 统一服务商抽象与调用层
        ...
        if any(kw in user_message for kw in ["接下来", "下一步", "顺序", "先学", "学什么", "路径"]):
            ...
            return {
                ...
                "suggested_actions": [
                    ...
                    f"3. 随后稳步衔接 Stage {first_three[1].get('stage', 2)}：【{first_three[1].get('knowledge_name', '')}】" if len(first_three) > 1 else "3. 检验阶段成果并更新学情画像"
                ]
            }
